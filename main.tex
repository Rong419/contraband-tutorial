...
>>>>>>> 49244f8d516fd71c7ff6e06571facdd2c59c7535
...
For those who are curious about the FBD model, BEAST2 has a dedicated tutorial for it (\href{https://taming-the-beast.org/tutorials/FBD-tutorial/}{here}).
...
The first thing we will note is that the ESS values are all below 200 and shown in red -- obviously our Markov chain needs to run for much longer for us to safely conclude anything about the biological system we are studying.
...
\item The estimated character correlations 
